...
public class UserController {
	...
	@RequestMapping(value = "/userList.json", method = RequestMethod.GET,headers="Accept=application/json")
	...
	public @ResponseBody User getUserByUserName(@PathVariable("uName") String userName) {
